/**
 * Shared line-item money math for invoices. Kept in its own module so the
 * parser (which computes the subtotal) and the renderer (which shows each
 * line's net amount) apply the exact same per-line discount formula and can
 * never drift apart.
 *
